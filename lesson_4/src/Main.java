...
public class Main {
    ...
    public static int[] heroesHealth = {280, 270, 250, 100, 200, 150};
    public static int[] heroesDamage = {10, 15, 20, 0, 30, 15};
    ...
    public static void luckySkill() {
        ...
        if (heroesHealth[5] > 0 && lucky) {
            ...
            System.out.println("Lucky dodged the boss " + true);
        }
    }

    public static void thorSkill() {
        Random rn = new Random();
        boolean at = rn.nextBoolean();
        for (int i = 0; i < heroesHealth.length; i++) {
            if (heroesHealth[4] > 0) {
                if (at) {
                    bossDamage = 0;
                    System.out.println("Thor stunned the boss " + at);
                    break;
                }
            } else {
                bossDamage = 50;
